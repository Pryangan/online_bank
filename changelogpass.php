...
if (x==null || x=="")
  ...
  return false;
    ...
    <table width="1331" bgcolor="#FFFFCC"><tr><td width="70%">
        	...
        	<form onsubmit="return valid()" id="form1" name="form1" method="post" action="">
        	  ...
        	  <table width="606" height="314" border="0">
        	    ...
        	    <tr>
        	      ...
        	      <td width="210"><input name="loginid" type="text" id="loginid" size="35" readonly="readonly" value="<?php echo $_SESSION[loginid]; ?>"/></td>
      	      </tr>
        	    <tr>
