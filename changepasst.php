...
{
mysql_query("UPDATE employees SET password='$_POST[newpass]' WHERE customerid = '$_POST[customerid]' AND accpassword='$_POST[oldpass]'");
        	...
        	<form id="form1" name="form1" method="post" action=""onsubmit="return validateForm()">
        	  ...
        	  <table width="561" height="292" border="0">
        	    ...
        	    <tr>
        	      ...
        	      <td width="210"><input name="loginid" type="text" id="loginid" size="35" readonly="readonly" value="<?php echo $_SESSION["loginid"]; ?>"/>
                  </td>
      	      </tr>
        	    <tr>
