...
{
mysql_query("UPDATE customers SET transpasword='$_POST[newpass]' WHERE customerid = '$_SESSION[customerid]' AND transpasword='$_POST[oldpass]'");
...
?>
    ...
    <table width="1348" bgcolor="#FFFFCC"><tr><td width="70%">
        	...
        	<form id="form1" name="form1" method="post" action=""onsubmit="return validateForm()">
        	  ...
        	  <table width="459" height="239" border="0">
        	    ...
        	    <tr>
        	      ...
        	      <td><input name="loginid" type="text" id="loginid" size="35" readonly="readonly" value="<?php echo $_SESSION["loginid"]; ?>"/></td>
      	      </tr>
        	    <tr>
