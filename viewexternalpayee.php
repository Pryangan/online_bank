...
VALUES
('$_SESSION[customer_id]','$_POST[p_name]','$_POST[ac_no]','$_POST[ac_type]','$_POST[bank_name]','$_POST[code]')";
...
{
$result1 = mysql_query("select * from registered_payee WHERE customer_id='$_SESSION[customer_id]'");
     ...
     <div id="templatemo_main"><span class="main_top"></span> 
        ...
        <div id="templatemo_content">
        	...
        	<form id="form1" name="form1" method="post" action="" onsubmit="return validateForm()">
			  ...
			  {
        	   echo " <tr>
        	      <td>$arrvar[payee_name]</td>
				   <td>$arrvar[bank_name]</td>
        	      <td>$arrvar[account_no]</td>
				   <td>$arrvar[acc_type]</td>
				     <td>$arrvar[ifsc_code]</td>
        	      <td><a href='addexternalpayee.php?payeeid=$arrvar[sl_no]'>Update</a></td>
      	      </tr>";
			  }
			  ?>
